...
function renderEnv(a: Answers, keep: Record<string, EnvEntry>): RenderedEnv {
  ...
  if (a.authMode === "google") {
    ...
    put(
      ...
      keep.GOOGLE_CLIENT_SECRET?.value || "CHANGEME-google-client-secret",
    );
  ...
  if (a.mode === "tailscale") {
    ...
    put("TS_AUTHKEY", keep.TS_AUTHKEY?.value || "tskey-auth-CHANGEME");
    L.push("");
  }
